...
def inference1(x_data, stockCode):
    ...
    # denormalize 전에 바로 찍기
    print("raw volume  :", y_volume.ravel()[0])   # 예: 211.5 ?
    print("raw investor:", y_investor.ravel()[0])
    print("raw short   :", y_short.ravel()[0])
